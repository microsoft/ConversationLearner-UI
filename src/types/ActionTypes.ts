export enum AT {
    ...
    CREATE_TEACH_SESSION_FROMBRANCHASYNC = 'CREATE_TEACH_SESSION_FROM_SPLIT_ASYNC',
    CREATE_TEACH_SESSION_FROMBRANCHFULFILLED = 'CREATE_TEACH_SESSION_FROM_SPLIT_FULFILLE',
