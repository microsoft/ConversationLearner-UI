...
export enum FM {
    ...
    PROFILE_SETTINGS_BOT_PORT_DESCRIPTION = 'Profile.settings.sdkPort.description',
    PROFILE_SETTINGS_BOT_PORT_USE_CUSTOM = 'Profile.settings.useCustomPort',
    ...
    ACTIONCREATOREDITOR_WARNING_NON_WAIT_HAS_EXPECTED_ENTITY = 'ActionCreatorEditor.warningNonEmptyFields',
    ...
    // ActionList Columns
    ACTIONLIST_COLUMNS_RESPONSE = 'ActionListColumns.response',
    ACTIONLIST_COLUMNS_ARGUMENTS = 'ActionListColumns.arguements',
    ACTIONLIST_COLUMNS_ISTERMINAL = 'ActionListColumns.isTerminal',
    ...
    // ActionSelector
    ACTIONSELECTOR_TITLE = 'ActionSelector.title',
    ...
    ENTITIES_COLUMNS_IS_MULTIVALUE = 'Entities.columns.isMultivalue',
    ...
    ENTITYCREATOREDITOR_FIELDS_RESOLVER_RESOLUTION_REQUIRED_LABEL = 'EntityCreatorEditor.fields.resolverResolutionRequired.label',
    ENTITYCREATOREDITOR_FIELDS_RESOLVER_RESOLUTION_REQUIRED_HELPTEXT = 'EntityCreatorEditor.fields.resolverResolutionRequired.helpText',
    ...
    // RepromptAction
    REPROMPTACTION_SELECTACTION_BUTTON = 'RepromptAction.selectActionButton',
    REPROMPTACTION_SAME_CHOICE = 'RepromptAction.sameChoiceButton',
    REPROMPTACTION_DIFFERENT_CHOICE = 'RepromptAction.sameDifferentButton',
    ...
    TOOLTIP_ENTITY_EXTRACTOR_MATCH_WARNING = 'ToolTip.ENTITY_EXTRACTOR_MATCH_WARNING',
    TOOLTIP_ENTITY_EXTRACTOR_DUPE_WARNING1 = 'ToolTip.ENTITY_EXTRACTOR_DUPE_WARNING1',
    TOOLTIP_ENTITY_EXTRACTOR_DUPE_WARNING2 = 'ToolTip.ENTITY_EXTRACTOR_DUPE_WARNING2',
...
export default {
    'en-US': {
        ...
        [FM.PROFILE_SETTINGS_BOT_PORT_USE_CUSTOM]: 'Use Custom Port',
        [FM.PROFILE_SETTINGS_BOT_PORT_DESCRIPTION]: 'Normally this administrative interface is served from the bot which implies PORT: { port } is also the bot port and it will use this by default. For special cases such as development you can choose to override and use a custom port.',
        ...
        [FM.ACTIONCREATOREDITOR_CHECKBOX_REPROMPT_LABEL]: 'Prompt on unexected user input',
        ...
        [FM.ACTIONCREATOREDITOR_WARNING_NON_WAIT_HAS_EXPECTED_ENTITY]: `Non-wait Actions can't have Expected Entities`,
        ...
        // ActionList Columns
        [FM.ACTIONLIST_COLUMNS_RESPONSE]: 'Response',
        [FM.ACTIONLIST_COLUMNS_ARGUMENTS]: 'Arguments',
        [FM.ACTIONLIST_COLUMNS_ISTERMINAL]: 'Wait',
        [FM.ACTIONLIST_COLUMNS_TYPE]: 'Type',
        [FM.ACTIONLIST_COLUMNS_CONDITIONS]: 'Conditions',
        [FM.ACTIONLIST_COLUMNS_REPROMPT]: 'Reprompt',
        ...
        [FM.ENTITYCREATOREDITOR_FIELDS_RESOLVER_RESOLUTION_REQUIRED_LABEL]: 'Resolution Required',
        ...
        [FM.ENTITYCREATOREDITOR_DELETE_ERROR_WARNING]: 'It is either referenced within the bot response, used as expected entity, or used to set an entity by one or more Actions',
        ...
        [FM.ENTITIES_COLUMNS_IS_MULTIVALUE]: 'Multi-Value',
        ...
        // RepromptAction
        [FM.REPROMPTACTION_SELECTACTION_BUTTON]: 'Change Action',
        [FM.REPROMPTACTION_SAME_CHOICE]: 'Repeat Same Action',
        [FM.REPROMPTACTION_DIFFERENT_CHOICE]: 'Show a Different Action',
        ...
        [FM.TOOLTIP_ACTION_SET_ENTITY]: `Since these are actions they can be learned just like any other action in your bot.`,
        ...
        [FM.TOOLTIP_ENTITY_EXTRACTOR_MATCH_WARNING]: 'Equivalent input must contain the same detected Entities as the original input text.',
        [FM.TOOLTIP_ENTITY_EXTRACTOR_DUPE_WARNING1]: 'Entities that are not multi-value (i.e. ',
        [FM.TOOLTIP_ENTITY_EXTRACTOR_DUPE_WARNING2]: ') will only store the last labelled utterance',
