export enum FM {
    ...
    APPCREATOR_FIELDS_LUISKEY_AUTHORING_LABEL = 'AppCreator.fields.luisKey.authoring.label',
    APPCREATOR_FIELDS_LUISKEY_AUTHORING_HELPTEXT = 'AppCreator.fields.luisKey.authoring.helptext',
    APPCREATOR_FIELDS_LUISKEY_AUTHORING_PLACEHOLDER = 'AppCreator.fields.luisKey.authoring.placeholder',
    APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_LABEL = 'AppCreator.fields.luisKey.subscription.label',
    APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_HELPTEXT = 'AppCreator.fields.luisKey.subscription.helptext',
    APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_PLACEHOLDER = 'AppCreator.fields.luisKey.subscription.placeholder',
...
export default {
    'en-US': {
        ...
        [FM.ACTIONCREATOREDITOR_CONFIRM_DELETE_WARNING]: 'This Action is used by one or more Training Dialogs.  If you proceed you will need they will removed from training until fixed.',
        [FM.ACTIONCREATOREDITOR_CONFIRM_EDIT_TITLE]: 'Are you sure you want to edit this action?',
        [FM.ACTIONCREATOREDITOR_CONFIRM_EDIT_WARNING]: 'This edit will invalidate one or more Training Dialogs.  If you proceed you will need they will removed from training until fixed.',
        ...
        [FM.APPCREATOR_FIELDS_LUISKEY_AUTHORING_LABEL]: 'LUIS Authoring Key',
        [FM.APPCREATOR_FIELDS_LUISKEY_AUTHORING_HELPTEXT]: 'Find your authoring key',
        [FM.APPCREATOR_FIELDS_LUISKEY_AUTHORING_PLACEHOLDER]: 'Authoring Key...',
        [FM.APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_LABEL]: 'LUIS Subscription Key',
        [FM.APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_HELPTEXT]: 'Find your subscription key',
        [FM.APPCREATOR_FIELDS_LUISKEY_SUBSCRIPTION_PLACEHOLDER]: 'Subscription Key...',
