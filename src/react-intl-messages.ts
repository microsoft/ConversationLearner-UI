...
export enum FM {
    ...
    ENTITYCREATOREDITOR_FIELDS_QUANTIZE_LABEL = 'EntityCreatorEditor.fields.quantize.label',
    ENTITYCREATOREDITOR_FIELDS_QUANTIZE_HELPTEXT = 'EntityCreatorEditor.fields.quantize.helpText',
    ENTITYCREATOREDITOR_FIELDS_QUANTIZE_RANGEPOINTS_PLACEHOLDER = 'EntityCreatorEditor.fields.rangePoints.placeholder',
...
export default {
    'en-US': {
        ...
        [FM.ENTITYCREATOREDITOR_FIELDS_QUANTIZE_LABEL]: 'Quantize',
        [FM.ENTITYCREATOREDITOR_FIELDS_QUANTIZE_RANGEPOINTS_PLACEHOLDER]: '18,65',
