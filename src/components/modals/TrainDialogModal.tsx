...
class TrainDialogModal extends React.Component<Props, ComponentState> {
    ...
    onClickBranch() {
        if (this.state.selectedActivity) {
            let roundIndex = this.state.selectedActivity.channelData.roundIndex
            let scoreIndex = this.state.selectedActivity.channelData.scoreIndex
            let senderType = this.state.selectedActivity.channelData.senderType
            this.props.onBranch(roundIndex, scoreIndex, senderType)
        }
        else {
            this.setState({
                calloutOpen: true
...
export interface ReceivedProps {
    ...
    canEdit: boolean,
    onClose: () => void,
    onBranch: (roundIndex: number, scoreIndex: number, senderType: SenderType) => void,
