...
class OBIImporter extends React.Component<Props, ComponentState> {
...
export default connect<typeof stateProps, typeof dispatchProps, ReceivedProps>(mapStateToProps, mapDispatchToProps)(injectIntl(OBIImporter))