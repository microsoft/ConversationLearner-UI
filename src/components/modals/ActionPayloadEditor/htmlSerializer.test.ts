...
describe('Slate - Html Serializer', () => {
    describe('deserialize', () => {
        test('should deserialize value from HTML the same as default JSON', () => {
            const testData = {
                text: 'Suffix',
                html: '<p>This required <b data-id="1f99bb7a-41af-46bb-b2f0-9c5c23404266" data-name="myEntity">$myEntity</b> and <i>[optional <b data-id="7d27f6a3-566a-487f-9345-79ea1db62708" data-name="otherEntity">$otherEntity</b> ]</i> ending.</p>',
            ...
            let slateValueFromHtml = HtmlSerializer.deserialize(testData.html)
            ...
            const stringFromJson = Plain.serialize(slateValueFromJson)
            const stringFromHtml2 = HtmlSerializer.serialize(slateValueFromHtml)
            const stringFromJson2 = HtmlSerializer.serialize(slateValueFromHtml)
