...
import { CreateAction } from './ActionObject'
export const createBLISApplication = (application: BLISApplication): CreateAction => {
...
export const createEntity = (entity: Entity): CreateAction => {
...
export const createAction = (action: Action): CreateAction => {
...
export const createTrainDialog = (trainDialog: TrainDialog): CreateAction => {
